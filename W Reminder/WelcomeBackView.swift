...
struct WelcomeBackView: View {
    ...
    private func startAnimationSequence() {
        ...
        // Auto-dismiss after a few seconds if user doesn't click (Optional, but "Popup" usually requires interaction)
        // I'll stick to manual dismiss for now as it feels more "Welcome" page-like.
    }
}
